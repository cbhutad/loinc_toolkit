...
"VersionLastChanged", "VersionFirstReleased", "RelatedNames", "CommonTestRank" })
public class SearchModel implements Comparable<SearchModel> {
	 ...
	 * @param relatedNames
     * @param commonTestRank
     */

    public SearchModel(String lOINC_NUMBER, String lONG_COMMON_NAME, String shortName,String cOMPONENT, String mETHOD_TYP,
    ...
    String exampleUnits, String relatedName, Integer commonTestRank) {
        super();
    ...
    public int compareTo(SearchModel obj) {
        return this.CommonTestRank.compareTo(obj.getCommonTestRank());
    }
}
