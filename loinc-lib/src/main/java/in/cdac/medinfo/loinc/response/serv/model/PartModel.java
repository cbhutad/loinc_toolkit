...
public class PartModel {
    ...
    private String getLOINC_PART_NUMBER() {
        return this.LOINC_PART_NUMBER;
    }

    @JsonProperty("LOINC_PART_NUMBER")
    private void setLOINC_PART_NUMBER(String loinc_PART_NUMBER) {
        this.LOINC_PART_NUMBER = loinc_PART_NUMBER;
    }

    @JsonProperty("LOINC_PART_NAME")
    private String getLOINC_PART_NAME() {
        return this.LOINC_PART_NAME;
    }

    @JsonProperty("LOINC_PART_NAME")
    private void setLOINC_PART_NAME(String LOINC_PART_NAME) {
        this.LOINC_PART_NAME = LOINC_PART_NAME;
    }

    @JsonProperty("LOINC_PART_DESCRIPTION")
    private String getLOINC_PART_DESCRIPTION() {
        return this.LOINC_PART_DESCRIPTION;
    }

    @JsonProperty("LOINC_PART_DESCRIPTION")
    private void setLOINC_PART_DESCRIPTION(String LOINC_PART_DESCRIPTION) {
